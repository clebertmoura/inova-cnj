                ...
                if not arquivo_valido:
                    ...
                    if sucesso_envio_cda:
                        try:
                            ...
                            print(npu + "|" + cda + "|IPTU:" + cda_ano_menor_exercicio_iptu +
                                  "|" + cda_ano_maior_exercicio_iptu + "|TLP:" + cda_ano_menor_exercicio_tlp +
                                  "|" + cda_ano_maior_exercicio_tlp + "|OUTROS:" +
                                  cda_ano_menor_exercicio_outros + "|" + cda_ano_maior_exercicio_outros)
                        except:
                            print("Arquivo " + filename_pdf + " invalido")
                            npu_cda_invalidas.append(npu)
